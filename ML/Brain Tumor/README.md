...
| Technique | Purpose |
|-----------|---------|
| Random Rotation (±10°) | Scan orientation variance |
...
| Epochs | 150 w/ early stoppage (25 epochs) |
| Batch Size | 32 |
...
│
├── 📂 notebooks/
│   ├── matlab_to_jpg.ipynb                  # .mat → .jpg conversion & preprocessing
│   ├── eda.ipynb                            # Exploratory Data Analysis
│   └── resnet.ipynb                         # Training, evaluation & results
│
├── 📂 static/
